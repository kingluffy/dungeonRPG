                ...
                switch (show_menu) {
                    ...
                    case 4:
                        ...
                        if (select > 0) {
                            ...
                            switch(m_item){
                                case 5:
                                    if(buy5 == 1 && menu_up != 165){
                                        g.setColor(Color.red);
                                    }
                                    break;
                                case 8:
                                    if(buy8 == 1 && menu_up != 165 || lvl < 15 && menu_up != 165){
                                        g.setColor(Color.red);
                                    }
                                    break;
                                case 9:
                                    if(buy9 == 1 && menu_up != 165){
                                        g.setColor(Color.red);
                                    }
                                    break;
                                case 11:
                                    if(buy11 == 1 && menu_up != 165){
                                        g.setColor(Color.red);
                                    }
                                    break;
                            }
